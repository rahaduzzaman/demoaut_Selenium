...
public class Register {
	...
	public void registration(WebDriver driver) throws Exception{
		...
		ReportUtils.reportResult("Pass", "Form Inputs", "All Fields are filled with data");
		...
		if(noteValidation)
			...
			ReportUtils.reportResult("Fail", "Note is Not Matching", "Expected Note: "+expectedNote + "\n Actual Note: "+actualNote);
		...
		if(expectedUserName.equals(actualUserName))
			...
			ReportUtils.reportResult("Pass", "UserName is Not Matching", "Expected Username: "+expectedUserName +"\n Actual Username: "+actualUserName);
