...
public class BookAFlightValidatePrice {
	...
	public void validatePrice(WebDriver driver){
		...
		if((departReturnFlightPrice*noOfPassengersInt)+taxInt == totalPriceInt)
			ReportUtils.reportResult("Pass", "validatePrice", "Total price displayed is correct!");
			
		else
			ReportUtils.reportResult("Pass", "validatePrice", "Total price displayed is NOT correct!");
